...
from src.models.social_links import SocialLinks as model
from src.schemas.social_links import  SocialLinksCreate as create_schema
...
class SocialLinksService:
    ...
    async def create(self, body: create_schema):
        ...
        await self._sess.refresh(db_model)
        return db_model
